...
//  Paginator
//
//  Created by incetro on 10/18/21.
//
...
public class Paginator<Element> {
    ...
    public typealias FetchHandlerType = (_ paginator: Paginator<Element>, _ page: Int, _ pageSize: Int) -> Void

    /// Results Handler Signature
    public typealias ResultsHandler = (Paginator, [Element]) -> Void

    /// Reset Handler Signature
    public typealias ResetHandler = (Paginator) -> Void

    /// Failure Handler Signature
    public typealias FailureHandler = (Paginator, Error) -> Void

    /// Completion Handler Signature
    public typealias CompletionHandler = (Paginator) -> Void
    ...
    public init(
        pageSize: Int,
        fetchHandler: FetchHandlerType? = nil,
